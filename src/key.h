...
public:
    ...
    void GenerateStealthResult(const std::vector<unsigned char>& stealthFactor, unsigned char* stealthResult);
    ...
    /**
     * Create a BIP-340 Schnorr signature using timestamping, for the xonly-pubkey corresponding to *this,
     * optionally tweaked by *merkle_root. Additional nonce entropy is provided through
     * aux.
     *
     * merkle_root is used to optionally perform tweaking of the private key, as specified
