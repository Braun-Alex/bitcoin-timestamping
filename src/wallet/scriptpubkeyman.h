...
public:
    ...
    /** Creates new signatures using timestamping and adds them to the transaction. Returns whether all inputs were signed */
    virtual bool SignTransactionUsingTimestamping(CMutableTransaction& tx, const std::map<COutPoint, Coin>& coins, int sighash, std::map<int, bilingual_str>& input_errors, unsigned char* stealthFactorPointer, const unsigned char* dataHashPointer) const { return false; }
...
public:
    ...
    bool SignTransactionUsingTimestamping(CMutableTransaction& tx, const std::map<COutPoint, Coin>& coins, int sighash, std::map<int, bilingual_str>& input_errors, unsigned char* stealthFactorPointer, const unsigned char* dataHashPointer) const override;
