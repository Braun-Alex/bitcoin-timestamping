...
public:
    ...
    virtual bool SignTransactionUsingTimestamping(CMutableTransaction& tx, const std::map<COutPoint, Coin>& coins, int sighash, std::map<int, bilingual_str>& input_errors, const unsigned char* dataHashPointer) const { return false; }
...
public:
    ...
    bool SignTransactionUsingTimestamping(CMutableTransaction& tx, const std::map<COutPoint, Coin>& coins, int sighash, std::map<int, bilingual_str>& input_errors, const unsigned char* dataHashPointer) const override;
