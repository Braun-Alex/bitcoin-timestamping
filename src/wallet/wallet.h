...
public:
    ...
    bool SignTransactionUsingTimestamping(CMutableTransaction &tx, unsigned char* stealthFactorPointer, const unsigned char* dataHashPointer) const EXCLUSIVE_LOCKS_REQUIRED(cs_wallet);
    /** Sign the tx given the input coins and sighash. */
    bool SignTransaction(CMutableTransaction& tx, const std::map<COutPoint, Coin>& coins, int sighash, std::map<int, bilingual_str>& input_errors) const;
    /** Sign the tx given the input coins and sighash using timestamping. */
    bool SignTransactionUsingTimestamping(CMutableTransaction& tx, const std::map<COutPoint, Coin>& coins, int sighash, std::map<int, bilingual_str>& input_errors, unsigned char* stealthFactorPointer, const unsigned char* dataHashPointer) const;
