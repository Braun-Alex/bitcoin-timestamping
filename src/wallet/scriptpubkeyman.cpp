...
bool LegacyScriptPubKeyMan::SignTransactionUsingTimestamping(CMutableTransaction& tx, const std::map<COutPoint, Coin>& coins, int sighash, std::map<int, bilingual_str>& input_errors, const std::string& dataHash) const
{
    return ::SignTransactionUsingTimestamping(tx, this, coins, sighash, input_errors, dataHash);
}
...
bool DescriptorScriptPubKeyMan::SignTransactionUsingTimestamping(CMutableTransaction& tx, const std::map<COutPoint, Coin>& coins, int sighash, std::map<int, bilingual_str>& input_errors, const std::string& dataHash) const
{
    ...
    return ::SignTransactionUsingTimestamping(tx, keys.get(), coins, sighash, input_errors, dataHash);
}
