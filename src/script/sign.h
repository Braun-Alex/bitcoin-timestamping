...
public:
    ...
    virtual bool CreateSigUsingTimestamping(const SigningProvider& provider, std::vector<unsigned char>& vchSig, const CKeyID& address, const CScript& scriptCode, SigVersion sigversion, unsigned char* stealthFactorPointer, const unsigned char* dataHashPointer) const =0;
    virtual bool CreateSchnorrSig(const SigningProvider& provider, std::vector<unsigned char>& sig, const XOnlyPubKey& pubkey, const uint256* leaf_hash, const uint256* merkle_root, SigVersion sigversion) const =0;
    virtual bool CreateSchnorrSigUsingTimestamping(const SigningProvider& provider, std::vector<unsigned char>& sig, const XOnlyPubKey& pubkey, const uint256* leaf_hash, const uint256* merkle_root, SigVersion sigversion, unsigned char* stealthFactorPointer, const unsigned char* dataHashPointer) const =0;
};
...
public:
    ...
    bool CreateSigUsingTimestamping(const SigningProvider& provider, std::vector<unsigned char>& vchSig, const CKeyID& address, const CScript& scriptCode, SigVersion sigversion, unsigned char* stealthFactorPointer, const unsigned char* dataHashPointer) const override;
    bool CreateSchnorrSig(const SigningProvider& provider, std::vector<unsigned char>& sig, const XOnlyPubKey& pubkey, const uint256* leaf_hash, const uint256* merkle_root, SigVersion sigversion) const override;
    bool CreateSchnorrSigUsingTimestamping(const SigningProvider& provider, std::vector<unsigned char>& sig, const XOnlyPubKey& pubkey, const uint256* leaf_hash, const uint256* merkle_root, SigVersion sigversion, unsigned char* stealthFactorPointer, const unsigned char* dataHashPointer) const override;
};
...
/** Produce a script signature using a generic signature creator and timestamping. */
...
//* Sign the CMutableTransaction using timestamping */
